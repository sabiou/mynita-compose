 ...
 */
@Composable
fun RowScope.MyNitaNavigationBarItem(
    selected: Boolean,
    onClick: () -> Unit,
    ...
    NavigationBarItem(
        ...
        colors = NavigationBarItemDefaults.colors(
            selectedIconColor = NitaTheme.colors.burntSienna,
            unselectedIconColor = Color.Gray,
            selectedTextColor = NitaTheme.colors.burntSienna,
